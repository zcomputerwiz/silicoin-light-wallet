...
# Allows overriding the branch or commit to build in silicoin-light-gui
SUBMODULE_BRANCH=$1
...
echo ""
echo "Type 'cd silicoin-light-gui' and then 'npm run electron &' to start the GUI."
