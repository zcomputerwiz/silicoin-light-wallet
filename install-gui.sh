...
# Allows overriding the branch or commit to build in silicoin-blockchain-gui
SUBMODULE_BRANCH=$1
...
echo ""
echo "Type 'cd silicoin-blockchain-gui' and then 'npm run electron &' to start the GUI."
