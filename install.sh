...
python -m pip install --extra-index-url https://pypi.silicoin.net/simple/ miniupnpc==2.2.2
python -m pip install -e . --extra-index-url https://pypi.silicoin.net/simple/

echo ""
echo "Silicoin blockchain install.sh complete."
echo "For assistance join us on Keybase in the #support chat channel:"
echo "https://keybase.io/team/silicoin_network.public"
echo ""
echo "Try the Quick Start Guide to running silicoin-blockchain:"
