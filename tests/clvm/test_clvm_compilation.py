...
wallet_program_files = set(
    [
        "silicoin/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "silicoin/wallet/puzzles/cat.clvm",
        "silicoin/wallet/puzzles/chialisp_deserialisation.clvm",
        "silicoin/wallet/puzzles/rom_bootstrap_generator.clvm",
        "silicoin/wallet/puzzles/generator_for_single_coin.clvm",
        "silicoin/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "silicoin/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "silicoin/wallet/puzzles/everything_with_signature.clvm",
        "silicoin/wallet/puzzles/lock.inner.puzzle.clvm",
        "silicoin/wallet/puzzles/p2_conditions.clvm",
        "silicoin/wallet/puzzles/p2_delegated_conditions.clvm",
        "silicoin/wallet/puzzles/p2_delegated_puzzle.clvm",
        "silicoin/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "silicoin/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "silicoin/wallet/puzzles/p2_puzzle_hash.clvm",
        "silicoin/wallet/puzzles/rl_aggregation.clvm",
        "silicoin/wallet/puzzles/rl.clvm",
        "silicoin/wallet/puzzles/sha256tree_module.clvm",
        "silicoin/wallet/puzzles/singleton_top_layer.clvm",
        "silicoin/wallet/puzzles/did_innerpuz.clvm",
        "silicoin/wallet/puzzles/decompress_puzzle.clvm",
        "silicoin/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "silicoin/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "silicoin/wallet/puzzles/block_program_zero.clvm",
        "silicoin/wallet/puzzles/test_generator_deserialize.clvm",
        "silicoin/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "silicoin/wallet/puzzles/p2_singleton.clvm",
        "silicoin/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "silicoin/wallet/puzzles/pool_member_innerpuz.clvm",
        "silicoin/wallet/puzzles/singleton_launcher.clvm",
        "silicoin/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
        "silicoin/wallet/puzzles/delegated_genesis_checker.clvm",
    ]
)

clvm_include_files = set(
    ["silicoin/wallet/puzzles/create-lock-puzzlehash.clvm", "silicoin/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "silicoin/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to silicoin/wallet/puzzles, but not added to `wallet_program_files`
        """
