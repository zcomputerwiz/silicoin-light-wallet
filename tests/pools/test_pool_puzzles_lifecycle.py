...
from silicoin.wallet.puzzles.p2_conditions import puzzle_for_conditions
from silicoin.wallet.puzzles import singleton_top_layer
from silicoin.pools.pool_wallet_info import PoolState
from silicoin.pools.pool_puzzles import (
...
This test suite aims to test:
    - silicoin.pools.pool_puzzles.py
    - silicoin.wallet.puzzles.pool_member_innerpuz.clvm
    - silicoin.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
