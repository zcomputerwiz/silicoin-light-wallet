...
from silicoin.pools.pool_config import PoolWalletConfig
from silicoin.util.config import load_config, save_config, create_default_silicoin_config
...
def test_pool_config():
    ...
    create_default_silicoin_config(test_root, ["config.yaml"])
