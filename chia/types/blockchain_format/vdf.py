...
from silicoinvdf import create_discriminant, verify_n_wesolowski
...
from silicoin.types.blockchain_format.sized_bytes import bytes32, bytes100
from silicoin.util.ints import uint8, uint64
