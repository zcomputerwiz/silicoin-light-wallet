...
from silicoin.consensus.block_rewards import calculate_base_farmer_reward
from silicoin.pools.pool_wallet import PoolWallet
from silicoin.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
...
from silicoin.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from silicoin.util.path import path_from_root
...
from silicoin.wallet.derive_keys import master_sk_to_singleton_owner_sk, master_sk_to_wallet_sk_unhardened
from silicoin.wallet.rl_wallet.rl_wallet import RLWallet
from silicoin.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from silicoin.wallet.did_wallet.did_wallet import DIDWallet
from silicoin.wallet.trade_record import TradeRecord
from silicoin.wallet.transaction_record import TransactionRecord
from silicoin.wallet.util.trade_utils import trade_record_to_dict
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "silicoin_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "silicoin_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cat_wallet":
            ...
            if request["mode"] == "new":
                ...
                from silicoin.pools.pool_wallet_info import initial_pool_state_from_dict
