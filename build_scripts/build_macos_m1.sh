...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Silicoin-darwin-arm64/Silicoin.app --platform=darwin \
...
mv Silicoin-darwin-arm64 ../../../build_scripts/dist/
cd ../../../build_scripts || exit

DMG_NAME="Silicoin-$SILICOIN_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Silicoin-darwin-arm64/Silicoin.app Silicoin-$SILICOIN_INSTALLER_VERSION-arm64 \
