...
from silicoin.daemon.server import singleton, service_launch_lock_path
from silicoin.server.ssl_context import silicoin_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        silicoin_ca_crt, silicoin_ca_key = silicoin_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = SilicoinServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (silicoin_ca_crt, silicoin_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for SilicoinServer to be closed")
