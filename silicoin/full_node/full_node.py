...
from silicoin.full_node.full_node_store import FullNodeStore
...
from silicoin.protocols.full_node_protocol import (
    RequestBlocks,
    RespondBlock,
    RespondBlocks,
    RespondSignagePoint,
...
class FullNode:
    ...
    def set_server(self, server: SilicoinServer):
        ...
        if "dns_servers" in self.config:
            ...
            dns_servers.append("dns-introducer.sitnetwork.net")
        try:
