...
# the output will be printed to your silicoin root path, e.g. ~/.silicoin/mainnet/profile/
# to analyze the profile, run:

#   python silicoin/utils/profiler.py ~/.silicoin/mainnet/profile | less -r
...
#   python silicoin/utils/profiler.py ~/.silicoin/mainnet/profile 10 20
...
if __name__ == "__main__":
    ...
    def analyze_slot_range(profile_dir: pathlib.Path, first: int, last: int):
        ...
        output_file = "silicoin-hotspot-%d" % first
        if first < last:
            output_file += "-%d" % last
