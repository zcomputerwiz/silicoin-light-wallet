...
def class_for_type(type: NodeType) -> Any:
    if type is NodeType.FULL_NODE:
        ...
        from silicoin.wallet.wallet_node_api import WalletNodeAPI
        ...
        from silicoin.farmer.farmer_api import FarmerAPI

        return FarmerAPI
    elif type is NodeType.HARVESTER:
        from silicoin.harvester.harvester_api import HarvesterAPI
