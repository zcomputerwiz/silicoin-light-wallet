...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "introducer-testnet10.sitnetwork.net"
            testnet_dns_introducer = "dns-introducer-testnet10.sitnetwork.net"
            testnet = "testnet10"
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.sitnetwork.net"
            mainnet_dns_introducer = "dns-introducer.sitnetwork.net"
            net = "mainnet"
