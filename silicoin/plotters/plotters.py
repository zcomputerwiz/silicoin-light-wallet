...
from silicoin.plotters.bladebit import get_bladebit_install_info, plot_bladebit
from silicoin.plotters.chiapos import get_chiapos_install_info, plot_silicoin
from silicoin.plotters.madmax import get_madmax_install_info, plot_madmax
from silicoin.plotters.install_plotter import install_plotter
...
def call_plotters(root_path: Path, args):
    # Add `plotters` section in SILICOIN_ROOT.
    silicoin_root_path = root_path
    ...
    if not os.path.exists(root_path):
        print(f"Creating plotters folder within SILICOIN_ROOT: {root_path}")
        try:
            os.mkdir(root_path)
        except Exception as e:
    ...
    build_parser(subparsers, root_path, silicoin_plotter, "chiapos", "chiapos Plotter")
    ...
    if args.plotter == "chiapos":
        plot_silicoin(args, silicoin_root_path)
    if args.plotter == "madmax":
        plot_madmax(args, silicoin_root_path, root_path)
    if args.plotter == "bladebit":
        plot_bladebit(args, silicoin_root_path, root_path)
