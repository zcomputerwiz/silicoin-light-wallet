"""
NOTE: This contains duplicate code from `silicoin.cmds.plots`.
After `silicoin plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "silicoin Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_silicoin(args, root_path):
