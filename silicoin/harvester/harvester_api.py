...
from silicoin.plotting.util import PlotInfo, parse_plot_info
from silicoin.protocols import harvester_protocol
from silicoin.protocols.farmer_protocol import FarmingInfo
from silicoin.protocols.harvester_protocol import Plot
from silicoin.protocols.protocol_message_types import ProtocolMessageTypes
from silicoin.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSSilicoinConnection
    ):
        """
